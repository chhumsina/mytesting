...
<script type="text/javascript">
	...
	function login(response, info){
		if (response.authResponse) {
			...
			userInfo.innerHTML                             = ' <div class="col-md-6 portfolio-item"><a href="<?php echo BASE_URL;?>app/money"><img class="img-responsive" src="http://placehold.it/700x400" alt=""></a><h3><a href="#">Project One</a>	</h3><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p></div><div class="col-md-6 portfolio-item"><a href="#"><img class="img-responsive" src="http://placehold.it/700x400" alt="">	</a><h3><a href="#">Project Two</a>	</h3><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p></div>';
...
<div class="container">
	...
	<button class="btn btn-primary" id="fb-auth">Login</button>
